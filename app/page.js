          ...
          <div className="products-grid">
            <div className="product-card fade-in">
              ...
              <div className="product-body">
                ...
                <a href="https://frontlinepros.ai" className="btn btn-primary" style={{width: '100%', display: 'block', textAlign: 'center', textDecoration: 'none'}} target="_blank" rel="noopener noreferrer">Visit FrontlinePros</a>
              </div>
            </div>
            <div className="product-card fade-in">
              <div className="product-header">
